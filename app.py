...
def main():
    ...
    # ------------------------------------------------------------------
    # BLOQUE INSERTADO: MUESTRA VALORES NUMÉRICOS RESUELTOS
    # ------------------------------------------------------------------
    latex_formula_values = rf"\mathcal{{H}}_K = {vpn_base:,.0f}"
    for s in impactos:
        latex_formula_values += rf" + ({s['valor']:,.0f})"
    st.latex(latex_formula_values)
    # ------------------------------------------------------------------
